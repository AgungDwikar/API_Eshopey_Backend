...
function initModels(sequelize) {
  ...
  product_images.belongsTo(product_images, { as: "prim_prod", foreignKey: "prim_prod_id"});
  product_images.hasMany(product_images, { as: "product_images", foreignKey: "prim_prod_id"});
